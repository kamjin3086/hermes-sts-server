...
class Settings:
    ...
    web_search_providers: str = os.getenv("STS_WEB_SEARCH_PROVIDERS", "tavily,brave,searxng,duckduckgo")
    ...
    brave_api_key: str = os.getenv("BRAVE_API_KEY", os.getenv("BRAVA_API_KEY", ""))
    brave_base_url: str = os.getenv("BRAVE_BASE_URL", os.getenv("BRAVA_BASE_URL", "https://api.search.brave.com/res/v1"))
    brave_timeout_seconds: float = _float_env("BRAVE_TIMEOUT_SECONDS", _float_env("BRAVA_TIMEOUT_SECONDS", 2.5))

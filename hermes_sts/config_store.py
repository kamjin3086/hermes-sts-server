    ...
    def ensure_defaults(self) -> None:
        ...
        with self.connect() as conn:
            ...
            for key, value in {
                ...
                "terminal_tool_allowed_commands": "curl,python3,node,date,pwd,ls,rg,jq",
                "terminal_tool_cwd": str(ROOT),
                "terminal_tool_timeout_seconds": 6.0,
                "terminal_tool_max_output_chars": 4000,
